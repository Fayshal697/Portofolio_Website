...
export const TECHNICAL_SKILLS_LIST = [
  "Game Designer",
  "Augmented Reality Graphic Designer",
  "Secretariat",
  "UI Wireframe Prototype",
  "Data Analyst",
  "FOH",
  "Audio & Visual Team Leadership"
];
...
export const BADGE_IMAGES = [
  ...
  { src: "https://files.catbox.moe/sic3bx.png", name: "Unity AR Mobile Development" },
  { src: "https://files.catbox.moe/hv5u3r.png", name: "Unity VR Development" },
  { src: "https://files.catbox.moe/uccx6v.png", name: "Unity Junior Programmer" }
];